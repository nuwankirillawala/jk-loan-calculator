...
function SpeedLoanCalculator() {
  ...
  return (
    <CalculatorLayout
      title="Speed Loan Calculator"
      description="Calculate your monthly installment for speed loans. Interest is calculated monthly."
    >
...
export default SpeedLoanCalculator
